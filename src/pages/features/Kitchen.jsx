...
export default function Kitchen() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      <Helmet>
        <title>Kitchen Display System | Beypro</title>
        <meta name="description" content="Real-time order management with Beypro's Kitchen Display System" />
      </Helmet>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 items-center">
          <div>
            ...
            <p className="text-lg sm:text-xl text-slate-600 mb-6 sm:mb-8">
              Streamline kitchen operations with real-time order management and preparation tracking.
            </p>
