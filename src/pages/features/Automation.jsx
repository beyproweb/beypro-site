...
export default function Automation() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      <Helmet>
        <title>AI Automation | Beypro</title>
        <meta name="description" content="Smart business automation powered by AI" />
      </Helmet>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 items-center">
          <div>
            ...
            <p className="text-lg sm:text-xl text-slate-600 mb-6 sm:mb-8">
              Intelligent automation to reduce manual work, minimize errors, and boost efficiency.
            </p>
          ...
          <div className="relative w-full aspect-square">
            <img 
              src="https://images.unsplash.com/photo-1677442d019cecf123d11a9fa6c883b5e0266cf34?w=800&h=800&fit=crop" 
              alt="AI Automation" 
